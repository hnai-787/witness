...
The original version is a non-functional (load/stress) testing
exercise using Selenium IDE's record-and-playback tooling against two
live, real, third-party targets: 's student-portal login
...
**Original version**: this project performed non-functional (load)
testing against **a real, live university student-portal login
...
as originally submitted, for portfolio purposes, but this gap is flagged
